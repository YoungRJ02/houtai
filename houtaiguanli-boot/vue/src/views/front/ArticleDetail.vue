...
<!--            评论列表-->
      <div>
        <div v-for="item in comments" :key="item.id" style="border-bottom: 1px solid #ccc; padding: 10px 0; ">
              ...
              <div style="display: flex; line-height: 20px; margin-top: 5px">
                ...
                <div style="text-align: right; flex: 1">
                  ...
                  <el-popconfirm
                      ...
                      @confirm="del(item.id)"
                  >
                    <el-button type="text" style="color: red" slot="reference" v-if="user.id === item.userId">删除 <i class="el-icon-remove-outline"></i></el-button>
                  </el-popconfirm>
                </div>
              </div>
            </div>   <!--  内容-->
          ...
          <div v-if="item.children"  style="padding-left: 120px;">
